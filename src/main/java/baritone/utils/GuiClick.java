        ...
        if (currentMouseOver != null) { //Catch this, or else a click into void will result in a crash
            ...
            if (mouseButton == 0) {
                if (clickStart != null && !clickStart.equals(currentMouseOver)) {
                    client.player.sendMessage(Text.literal(String.format("/execute as %s run automatone sel clear", callerUuid)));
                    client.player.sendMessage(Text.literal(String.format("/execute as %s run automatone sel 1 %d %d %d", callerUuid, clickStart.getX(), clickStart.getY(), clickStart.getZ())));
                    client.player.sendMessage(Text.literal(String.format("/execute as %s run automatone sel 2 %d %d %d", callerUuid, currentMouseOver.getX(), currentMouseOver.getY(), currentMouseOver.getZ())));
                    ...
                    client.player.sendMessage(Text.literal(String.format("/execute as %s run automatone goto %d %d %d", callerUuid, currentMouseOver.getX(), currentMouseOver.getY(), currentMouseOver.getZ())));
                }
            } else if (mouseButton == 1) {
                client.player.sendMessage(Text.literal(String.format("/execute as %s run automatone goto %d %d %d", callerUuid, currentMouseOver.getX(), currentMouseOver.getY() + 1, currentMouseOver.getZ())));
            }
        }
        clickStart = null;
