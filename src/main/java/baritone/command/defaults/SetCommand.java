    ...
    public void execute(ServerCommandSource source, String label, IArgConsumer args, IBaritone baritone) throws CommandException {
        ...
        if (paginate) {
            ...
            Paginator.paginate(
                    ...
                    setting -> {
                        var typeComponent = Text.literal(String.format(
                                " (%s)",
                        ...
                        var component = Text.literal(setting.getName());
        ...
        if (!doingSomething && !args.hasAny()) {
            ...
            var oldValueComponent = Text.literal(String.format("Old value: %s", oldValue));
