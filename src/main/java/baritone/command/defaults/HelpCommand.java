        ...
        if (!args.hasAny() || args.is(Integer.class)) {
            Paginator.paginate(
                    ...
                    command -> {
                        ...
                        var component = Text.literal(name);
            ...
            logDirect(source, "");
            var returnComponent = Text.literal("Click to return to the help menu");
